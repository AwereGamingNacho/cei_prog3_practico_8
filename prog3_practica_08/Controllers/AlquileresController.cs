...
namespace prog3_practica_08.Controllers
{
    public class AlquileresController : Controller
    {
        ...
        {
            ViewBag.Copias = new List<Copia>(_context.Copias);
            ViewBag.Alquileres = new List<Alquilere>(_context.Alquileres);
            ViewBag.IdCliente = new SelectList(_context.Clientes, "Id", "Id");
